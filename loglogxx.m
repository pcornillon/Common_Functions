function [ax,hl1,hl2] = loglogxx(x1,y1,x2,y2,xlabels,ylabels);
% LOGLOGXX - Create graphs with x axes on both top and bottom 
%
%Similar to PLOTYY, but ...
%the independent variable is on the y-axis, 
%and both dependent variables are on the x-axis.
%
%Syntax: [ax,hl1,hl2] = loglogxx(x1,y1,x2,y2,xlabels,ylabels);
%
...
%ylabels{1} = 'Depth(m)';
%ylabels{2} = 'Depth(m)';
%[ax,hlT,hlS] = loglogxx(T,D,S,D,xlabels,ylabels);
...
hl2=loglog(x2,y2,'Color','r','Parent',ax(2));
